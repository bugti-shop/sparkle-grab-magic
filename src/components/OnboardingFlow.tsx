  ...
  if (showReadyScreen) {
    const journeySteps = [
      ...
      },
      {
        ...
        iconColor: '#1a1a1a',
        title: 'Today',
        description: 'Select your subscription and reach your productivity goals even faster.',
        completed: false,
      },
      {
        icon: Bell,
        iconBg: '#f0f0f0',
        iconColor: '#1a1a1a',
        title: 'Shortly before renewal',
        description: "You'll receive a reminder for your upcoming subscription renewal.",
        completed: false,
      },
      {
        icon: Info,
        ...
        iconColor: '#1a1a1a',
        title: 'Renewal day',
        description: 'Your subscription will be renewed and you can continue your Flowist journey.',
        completed: false,
      },
    ];
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-6 pt-2 pb-4">
          ...
          <motion.h1
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            className="text-[32px] font-black text-[#1a1a1a] font-['Nunito'] tracking-tight text-center leading-tight mb-8"
          >
            Ready to start your{'\n'}journey?
          </motion.h1>
              ...
              {journeySteps.map((s, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {s.completed ? (
                        <CheckCircle2 size={20} color="#1a1a1a" strokeWidth={2.5} />
                      ) : (
                        <StepIcon size={18} color={s.iconColor} strokeWidth={2} />
                      )}
                    </div>
                    <div className="pt-1">
          ...
          <motion.div
            ...
            style={{ backgroundColor: '#e8faf3' }}
          >
            <h3 className="text-[17px] font-bold text-[#1a1a1a] font-['Nunito'] leading-tight mb-1">
              How do I cancel<br />my subscription?
            </h3>
            <p className="text-[13px] text-[#5a6065] font-['Nunito_Sans'] leading-relaxed max-w-[200px]">
              Visit our Help Center for step-by-step instructions on how to cancel your Flowist subscription.
            </p>
          </motion.div>
        </div>
        ...
        <div className="px-6 pb-6 pt-2" style={{ paddingBottom: 'max(env(safe-area-inset-bottom, 0px), 24px)' }}>
          <motion.button
            ...
            style={{ backgroundColor: '#1a1a1a', color: '#ffffff', boxShadow: '0 8px 0 0 #000000' }}
            whileTap={{ scale: 0.97 }}
          >
            Continue
          </motion.button>
